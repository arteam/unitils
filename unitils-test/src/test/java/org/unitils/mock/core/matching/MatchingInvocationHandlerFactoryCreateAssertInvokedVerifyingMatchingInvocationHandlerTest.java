 ...
 * @author Tim Ducheyne
 */
public class MatchingInvocationHandlerFactoryCreateAssertInvokedVerifyingMatchingInvocationHandlerTest extends UnitilsJUnit4 {
    ...
    @Test
    public void createAssertInvokedVerifyingMatchingInvocationHandler() {
        MatchingInvocationHandler result = matchingInvocationHandlerFactory.createAssertInvokedVerifyingMatchingInvocationHandler();
        assertTrue(result instanceof AssertInvokedVerifyingMatchingInvocationHandler);
