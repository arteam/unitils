 ...
 * @author Tim Ducheyne
 */
public class BehaviorDefiningInvocationsAddBehaviorDefiningInvocationTest extends UnitilsJUnit4 {
    ...
    @Test
    public void addBehaviorDefiningInvocation() {
        ...
        assertEquals(asList(behaviorDefiningInvocation1, behaviorDefiningInvocation2), behaviorDefiningInvocations.getBehaviorDefiningInvocations());
    }
}
