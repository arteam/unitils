 ...
 * @author Tim Ducheyne
 */
public class ObservedInvocationGetBehaviorDefiningInvocationTest extends UnitilsJUnit4 {
    ...
    @Test
    public void getBehaviorDefiningInvocation() {
        BehaviorDefiningInvocation result = observedInvocation.getBehaviorDefiningInvocation();
        assertSame(behaviorDefiningInvocation, result);
    }
}
