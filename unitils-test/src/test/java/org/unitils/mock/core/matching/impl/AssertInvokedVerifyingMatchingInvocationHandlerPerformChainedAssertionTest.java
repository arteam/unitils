 ...
 * @author Tim Ducheyne
 */
public class AssertInvokedVerifyingMatchingInvocationHandlerPerformChainedAssertionTest extends UnitilsJUnit4 {
    ...
    public void performChainedAssertion() throws Throwable {
        ...
        Object result = assertInvokedVerifyingMatchingInvocationHandler.performChainedAssertion(mockMock.getMock());
