 ...
 * @author Tim Ducheyne
 */
public class MatchingInvocationHandlerFactoryCreateAssertInvokedInSequenceVerifyingMatchingInvocationHandlerTest extends UnitilsJUnit4 {
    ...
    @Test
    public void createAssertInvokedInSequenceVerifyingMatchingInvocationHandler() {
        MatchingInvocationHandler result = matchingInvocationHandlerFactory.createAssertInvokedInSequenceVerifyingMatchingInvocationHandler();
        assertTrue(result instanceof AssertInvokedInSequenceVerifyingMatchingInvocationHandler);
