 ...
 * @author Tim Ducheyne
 */
public class MockObjectOnceRaisesTest extends UnitilsJUnit4 {
    ...
    public void onceRaises() {
        ...
        Object result = mockObject.onceRaises(NullPointerException.class);
