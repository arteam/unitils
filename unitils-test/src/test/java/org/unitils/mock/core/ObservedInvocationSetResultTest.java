 ...
 * @author Tim Ducheyne
 */
public class ObservedInvocationSetResultTest extends UnitilsJUnit4 {
    ...
    public void setResult() {
        ...
        assertEquals("a", observedInvocation.getResult());
        assertEquals("b", observedInvocation.getResultAtInvocationTime());
    }

    @Test
    public void nullValues() {
        observedInvocation.setResult(null, null);
