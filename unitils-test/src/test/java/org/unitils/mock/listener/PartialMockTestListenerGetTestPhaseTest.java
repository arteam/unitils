 ...
 * @author Tim Ducheyne
 */
public class PartialMockTestListenerGetTestPhaseTest {
    ...
    public void initialize() {
        partialMockTestListener = new PartialMockTestListener(null);
    }


    @Test
    public void getTestPhase() {
        TestPhase result = partialMockTestListener.getTestPhase();
