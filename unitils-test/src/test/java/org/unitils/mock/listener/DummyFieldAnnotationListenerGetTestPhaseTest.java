 ...
 * @author Tim Ducheyne
 */
public class DummyFieldAnnotationListenerGetTestPhaseTest {
    ...
    public void initialize() {
        dummyFieldAnnotationListener = new DummyFieldAnnotationListener(null);
    }


    @Test
    public void getTestPhase() {
        TestPhase result = dummyFieldAnnotationListener.getTestPhase();
