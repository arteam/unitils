 ...
 * @author Tim Ducheyne
 */
public class DbMaintainWrapperClearDatabaseTest extends UnitilsJUnit4 {

    /* Tested object */
    private DbMaintainWrapper dbMaintainWrapper;

    protected Mock<MainFactory> mainFactoryMock;
    protected Mock<DBClearer> dbClearerMock;


    @Before
    public void initialize() {
        dbMaintainWrapper = new DbMaintainWrapper(mainFactoryMock.getMock(), true);
        mainFactoryMock.returns(dbClearerMock).createDBClearer();
    }
    ...
    public void clearDatabase() {
        ...
        dbClearerMock.assertInvoked().clearDatabase();
    }
}
