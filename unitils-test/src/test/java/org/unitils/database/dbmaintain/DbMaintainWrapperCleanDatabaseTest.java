 ...
 * @author Tim Ducheyne
 */
public class DbMaintainWrapperCleanDatabaseTest extends UnitilsJUnit4 {

    /* Tested object */
    private DbMaintainWrapper dbMaintainWrapper;

    protected Mock<MainFactory> mainFactoryMock;
    protected Mock<DBCleaner> dbCleanerMock;


    @Before
    public void initialize() {
        dbMaintainWrapper = new DbMaintainWrapper(mainFactoryMock.getMock(), true);
        mainFactoryMock.returns(dbCleanerMock).createDBCleaner();
    }
    ...
    public void cleanDatabase() {
        ...
        dbCleanerMock.assertInvoked().cleanDatabase();
    }
}
