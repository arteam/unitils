 ...
 * @author Tim Ducheyne
 */
public class DbMaintainDatabaseConnectionManagerTest extends UnitilsJUnit4 {
    ...
    @Test
    public void getSqlHandler() {
        SQLHandler result = dbMaintainDatabaseConnectionManager.getSqlHandler();
        assertSame(dbMaintainSQLHandler, result);
    }
}
