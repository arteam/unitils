 ...
 * @author Tim Ducheyne
 */
public class DatabaseConfigurationsGetDatabaseConfigurationsTest extends UnitilsJUnit4 {
    ...
    public void namedDatabases() {
        List<DatabaseConfiguration> result = databaseConfigurations.getDatabaseConfigurations();
        assertLenientEquals(asList(databaseConfigurationA, databaseConfigurationB), result);
    }
