 ...
 * @author Tim Ducheyne
 */
public class DataSourceWrapperGetRowsAsStringTest extends UnitilsJUnit4 {
    ...
    public void getObjectList() throws Exception {
        ...
        simpleJdbcTemplateMock.returns(rows).query("query", null, "arg");

        List<List<String>> result = dataSourceWrapper.getMock().getRowsAsString("query", "arg");
