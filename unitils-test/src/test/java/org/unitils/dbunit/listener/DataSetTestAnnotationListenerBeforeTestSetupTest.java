 ...
 * @author Tim Ducheyne
 */
public class DataSetTestAnnotationListenerBeforeTestSetupTest extends UnitilsJUnit4 {
    ...
    public void fileNamesSpecified() {
        ...
        dataSetTestAnnotationListener.beforeTestSetUp(testInstanceMock.getMock(), annotationsMock.getMock());
