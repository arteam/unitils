 ...
 * @author Tim Ducheyne
 */
public class DataSetTestAnnotationListenergetTestPhaseTest extends UnitilsJUnit4 {
    ...
    public void initialize() throws Exception {
        dataSetTestAnnotationListener = new DataSetTestAnnotationListener(null);
    }


    @Test
    public void getTestPhase() {
        TestPhase result = dataSetTestAnnotationListener.getTestPhase();
