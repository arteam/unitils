 ...
 * @author Tim Ducheyne
 */
public class SpringTestListenerAfterTestClassTest extends UnitilsJUnit4 {
    ...
    public void ignoredWhenNotASpringTest() throws Exception {
        springTestListener.afterTestClass(classWrapper);
    ...
    public void afterTestClass() throws Exception {
        ...
        springTestListener.afterTestClass(classWrapper);
        assertNull(MyTestExecutionListener.testContext.getTestInstance());
        assertNull(MyTestExecutionListener.testContext.getTestMethod());
    ...
    public void exceptionWhenAfterTestMethodFails() throws Exception {
        try {
            ...
            assertEquals("Exception occurred during after test class method.\n" +
