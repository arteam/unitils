    ...
    public void exceptionWhenUnableToRestore() {
        try {
            ...
            assertEquals("Unable to restore field with name 'objectValue' to value 'null'.\n" +
                    ...
                    "Reason: IllegalArgumentException: Can not set java.lang.String field org.unitils.core.reflect.OriginalFieldValueRestoreToNullOr0Test$MyClass.objectValue to java.lang.String", e.getMessage());
        }
    }
