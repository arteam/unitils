...
public class ClassWrapperGetCompositeFieldTest {
    ...
    public void simpleFieldDoesNotExist() throws Exception {
        try {
            ...
            assertEquals("Unable to get field for property 'xxx'. Field with name 'xxx' does not exist on class org.unitils.core.reflect.ClassWrapperGetCompositeFieldTest$MyClass or one of its superclasses.", e.getMessage());
        }
    }
