...
public class ClassWrapperCreateInstanceTest {
    ...
    public void exceptionWhenNoDefaultConstructor() {
        try {
            ...
            assertEquals("Unable to create instance of type org.unitils.core.reflect.ClassWrapperCreateInstanceTest$NoDefaultConstructor. No default (no-argument) constructor found.\n" +
                    "Reason: NoSuchMethodException: org.unitils.core.reflect.ClassWrapperCreateInstanceTest$NoDefaultConstructor.<init>()", e.getMessage());
        }
    }
    ...
    public void exceptionWhenNonStaticInnerClass() {
        try {
            ...
            assertEquals("Unable to create instance of type org.unitils.core.reflect.ClassWrapperCreateInstanceTest$NonStaticInnerClass. Type is a non-static inner class which is only know in the context of an instance of the enclosing class. Declare the inner class static to make construction possible.", e.getMessage());
        }
    }
    ...
    public void exceptionWhenConstructorRaisedException() {
        try {
            ...
            assertEquals("Unable to create instance of type org.unitils.core.reflect.ClassWrapperCreateInstanceTest$ConstructorRaisedException.\n" +
    ...
    public void exceptionWhenAbstractClass() {
        try {
            ...
            assertEquals("Unable to create instance of type org.unitils.core.reflect.ClassWrapperCreateInstanceTest$AbstractClass. Type is an abstract class.", e.getMessage());
        }
    }
