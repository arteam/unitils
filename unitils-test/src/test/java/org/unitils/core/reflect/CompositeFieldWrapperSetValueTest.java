...
public class CompositeFieldWrapperSetValueTest {
    ...
    public void autoCreatingForClassWithoutDefaultConstructor() throws Exception {
        ...
        try {
            ...
            assertEquals("Unable to set value for composite field with name 'inner1.inner2.inner3.field'. Could not auto create instance of inner field 'inner3'.\n" +
                    "Reason: Unable to create instance of type org.unitils.core.reflect.CompositeFieldWrapperSetValueTest$Inner3. No default (no-argument) constructor found.\n" +
                    "Reason: NoSuchMethodException: org.unitils.core.reflect.CompositeFieldWrapperSetValueTest$Inner3.<init>()", e.getMessage());
        }
    }
    ...
    public void fieldDoesNotExist() throws Exception {
        ...
        try {
            ...
            assertEquals("Unable to set value for field with name 'field'.\n" +
                    ...
                    "Reason: IllegalArgumentException: Can not set java.lang.String field org.unitils.core.reflect.CompositeFieldWrapperSetValueTest$OtherClass.field to org.unitils.core.reflect.CompositeFieldWrapperSetValueTest$MyClass", e.getMessage());
        }
    }
    ...
    public void compositeFieldDoesNotExist() throws Exception {
        ...
        try {
            ...
            assertEquals("Unable to set value for field with name 'field'.\n" +
                    "Make sure that the field exists on the target object and that the value is of the correct type: java.lang.String. Value: value\n" +
                    "Reason: IllegalArgumentException: Can not set java.lang.String field org.unitils.core.reflect.CompositeFieldWrapperSetValueTest$OtherClass.field to org.unitils.core.reflect.CompositeFieldWrapperSetValueTest$Inner1", e.getMessage());
        }
    }
