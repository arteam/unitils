    ...
    public void exceptionWhenUnableToRestore() {
        try {
            ...
            assertEquals("Unable to restore field with name 'value' to value 'original value'.\n" +
                    ...
                    "Reason: IllegalArgumentException: Can not set java.lang.String field org.unitils.core.reflect.OriginalFieldValueRestoreToOriginalValueTest$MyClass.value to java.lang.String", e.getMessage());
        }
    }
