    ...
    public void fieldDoesNotExist() {
        ...
        try {
            ...
            assertEquals("Unable to get value of field with name 'field'.\n" +
                    ...
                    "Reason: IllegalArgumentException: Can not set java.lang.String field org.unitils.core.reflect.FieldWrapperGetValueTest$OtherClass.field to org.unitils.core.reflect.FieldWrapperGetValueTest$MyClass", e.getMessage());
        }
    }
