...
public class ContextGetInstanceOfTypeTest extends UnitilsJUnit4 {
    ...
    public void noConfigFoundButTypeIsInterface() {
        try {
            ...
            assertEquals("Unable to create instance for type org.unitils.core.context.ContextGetInstanceOfTypeTest$TestInterface.\n" +
                    "Reason: No implementation type configured for given interface type org.unitils.core.context.ContextGetInstanceOfTypeTest$TestInterface", e.getMessage());
        }
    }
    ...
    public void tooManyConstructors() {
        ...
        try {
            ...
            assertEquals("Unable to create instance for type org.unitils.core.context.ContextGetInstanceOfTypeTest$TestInterface.\n" +
                    "Reason: Found more than 1 constructor in implementation type org.unitils.core.context.ContextGetInstanceOfTypeTest$TwoConstructorsClass", e.getMessage());
        }
    }
    ...
    public void implementationTypeShouldNotBeAnInterface() {
        ...
        try {
            ...
            assertEquals("Unable to create instance for type org.unitils.core.context.ContextGetInstanceOfTypeTest$TestInterface.\n" +
                    "Reason: Interface found as implementation type of org.unitils.core.context.ContextGetInstanceOfTypeTest$TestInterface", e.getMessage());
        }
    }
    ...
    public void implementationTypeShouldBeOfCorrectType() {
        ...
        try {
            ...
            assertEquals("Unable to create instance for type org.unitils.core.context.ContextGetInstanceOfTypeTest$TestInterface.\n" +
                    "Reason: Implementation type java.lang.StringBuffer is not of type org.unitils.core.context.ContextGetInstanceOfTypeTest$TestInterface or org.unitils.core.Factory<org.unitils.core.context.ContextGetInstanceOfTypeTest$TestInterface>", e.getMessage());
        }
    }
