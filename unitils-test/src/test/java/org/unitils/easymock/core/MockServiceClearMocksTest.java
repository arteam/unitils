 ...
 * @author Tim Ducheyne
 */
public class MockServiceClearMocksTest extends UnitilsJUnit4 {
    ...
    public void clearMocks() {
        ...
        mockService.replay();
        mocksControlMock1.assertInvoked().replay();
        mocksControlMock2.assertInvoked().replay();

        mockService.clearMocks();
        mockService.replay();
        mocksControlMock1.assertNotInvoked().replay();
        mocksControlMock2.assertNotInvoked().replay();
    }
