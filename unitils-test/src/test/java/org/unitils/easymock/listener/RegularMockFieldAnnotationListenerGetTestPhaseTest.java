 ...
 * @author Tim Ducheyne
 */
public class RegularMockFieldAnnotationListenerGetTestPhaseTest {
    ...
    public void initialize() {
        regularMockFieldAnnotationListener = new RegularMockFieldAnnotationListener(null);
    }


    @Test
    public void getTestPhase() {
        TestPhase result = regularMockFieldAnnotationListener.getTestPhase();
