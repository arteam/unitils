...
public class TestInstanceGetClassAnnotationsTest {
    ...
    public void annotationsOfType() {
        ...
        assertEquals("annotation1-sub", result.get(0).value());
        assertEquals("annotation1", result.get(1).value());
    }
    ...
    public void allAnnotations() {
        ...
        assertEquals("annotation1-sub", ((MyAnnotation1) result.get(0)).value());
        assertEquals("annotation2-sub", ((MyAnnotation2) result.get(1)).value());
        assertEquals("annotation1", ((MyAnnotation1) result.get(2)).value());
        assertEquals("annotation2", ((MyAnnotation2) result.get(3)).value());
    }
    ...
    @MyAnnotation1("annotation1-sub")
    @MyAnnotation2("annotation2-sub")
