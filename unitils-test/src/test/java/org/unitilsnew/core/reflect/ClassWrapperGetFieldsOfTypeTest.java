 ...
 * @author Tim Ducheyne
 */
public class ClassWrapperGetFieldsOfTypeTest {
    ...
    @Test
    public void getFieldsOfType() {
        classWrapper = new ClassWrapper(MyClass.class);

        List<FieldWrapper> result = classWrapper.getFieldsOfType(Type1.class);
    ...
    public void emptyWhenNoFieldsFoundOfType() {
        ...
        List<FieldWrapper> result = classWrapper.getFieldsOfType(Map.class);
    ...
    public void exceptionWhenNullType() {
        try {
            classWrapper = new ClassWrapper(MyClass.class);
            classWrapper.getFieldsOfType(null);
            fail("UnitilsException expected");
        } catch (UnitilsException e) {
            assertEquals("Unable to get fields of type. Type cannot be null.", e.getMessage());
        }
    }
