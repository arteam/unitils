...
public class ClassWrapperGetFieldTest {
    ...
    public void fieldDoesNotExist() throws Exception {
        try {
            ...
            assertEquals("Unable to get field with name 'xxx'. No such field exists on class org.unitilsnew.core.reflect.ClassWrapperGetFieldTest$MyClass or one of its superclasses.", e.getMessage());
        }
    }
