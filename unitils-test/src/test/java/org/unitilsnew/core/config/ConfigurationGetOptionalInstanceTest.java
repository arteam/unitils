 ...
 * @author Tim Ducheyne
 */
public class ConfigurationGetOptionalInstanceTest {
    ...
    public void validValue() {
        StringBuffer result = configuration.getOptionalInstance("instanceProperty");
        assertNotNull(result);
    }

    @Test(expected = UnitilsException.class)
    public void invalidValue() {
        configuration.getOptionalInstance("invalidClassNameProperty");
    }

    @Test(expected = ClassCastException.class)
    public void wrongType() {
        List result = configuration.getOptionalInstance("instanceProperty");
    }

    @Test
    public void valueIsTrimmed() {
        StringBuffer result = configuration.getOptionalInstance("propertyWithSpaces");
        assertNotNull(result);
    }

    @Test
    public void nullWhenNotFound() {
        Object result = configuration.getOptionalInstance("xxx");
        assertNull(result);
    }

    @Test
    public void nullWhenEmpty() {
        Object result = configuration.getOptionalInstance("empty");
        assertNull(result);
    }

    @Test
    public void valueWithClassifiers() {
        StringBuffer result = configuration.getOptionalInstance("propertyWithClassifiers", "a", "b");
        assertNotNull(result);
    }

    @Test
    public void factory() {
        Map result = configuration.getOptionalInstance("factory");
