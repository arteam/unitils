 ...
 * @author Tim Ducheyne
 */
public class SqlAssertAssertObjectListIntegrationTest {
    ...
    public void assertionSuccessfulForDefaultDatabase() throws Exception {
        ...
        SqlAssert.assertObjectList(asList(111, 222), Integer.class, "select value from my_table");
    }
    ...
    public void orderIsIgnored() throws Exception {
        executeUpdate("insert into my_table (value) values (111)");
        executeUpdate("insert into my_table (value) values (222)");
        SqlAssert.assertObjectList(asList(222, 111), Integer.class, "select value from my_table");
    }
    ...
    public void assertionSuccessfulForNamedDatabase() throws Exception {
        ...
        SqlAssert.assertObjectList(asList(111, 222), Integer.class, "select value from my_table", "database2");
    }
    ...
    public void assertionSuccessfulForEmptyResult() throws Exception {
        SqlAssert.assertObjectList(Collections.<Integer>emptyList(), Integer.class, "select value from my_table");
    }
    ...
    public void assertionSuccessfulForNullValue() throws Exception {
        ...
        executeUpdate("insert into my_table (value) values (null)");
        SqlAssert.assertObjectList(Arrays.<Integer>asList(null, null), Integer.class, "select value from my_table");
    }
    ...
    @Test
    public void exceptionWhenOtherTypeValue() throws Exception {
        executeUpdate("insert into my_table (other) values ('xxx')");
        try {
            SqlAssert.assertObjectList(asList(111), Integer.class, "select other from my_table");
    ...
    public void exceptionWhenDatabaseNameNotFound() throws Exception {
        try {
            SqlAssert.assertObjectList(asList(111), Integer.class, "select value from my_table", "xxx");
            fail("UnitilsException expected");
        } catch (UnitilsException e) {
    ...
    public void exceptionWhenInvalidStatement() throws Exception {
        try {
            SqlAssert.assertObjectList(asList(111), Integer.class, "xxx");
            fail("UnitilsException expected");
        } catch (UnitilsException e) {
