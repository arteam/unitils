...
public class AssertInvokedInSequenceVerifyingMatchingInvocationHandlerPerformAssertionTest extends UnitilsJUnit4 {
    ...
    public void initialize() {
        assertInvokedInSequenceVerifyingMatchingInvocationHandler = new AssertInvokedInSequenceVerifyingMatchingInvocationHandler(scenarioMock.getMock(), null);
    }


    @Test
    public void performAssertion() {
        assertInvokedInSequenceVerifyingMatchingInvocationHandler.performAssertion(scenarioMock.getMock(), behaviorDefiningInvocation);
        scenarioMock.assertInvoked().assertInvokedInSequence(behaviorDefiningInvocation);
    }
}
