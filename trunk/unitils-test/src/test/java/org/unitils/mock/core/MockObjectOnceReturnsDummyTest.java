 ...
 * @author Tim Ducheyne
 */
public class MockObjectOnceReturnsDummyTest extends UnitilsJUnit4 {
    ...
    public void initialize() {
        mockObject = new MockObject<Object>("name", Object.class, null, matchingProxy, false, behaviorDefiningInvocations,
                matchingProxyInvocationHandlerMock.getMock(), mockBehaviorFactoryMock.getMock(), matchingInvocationHandlerFactoryMock.getMock(), null, dummyFactory);
    }
    ...
    public void onceReturnsDummy() {
        ...
        Object result = mockObject.onceReturnsDummy();
