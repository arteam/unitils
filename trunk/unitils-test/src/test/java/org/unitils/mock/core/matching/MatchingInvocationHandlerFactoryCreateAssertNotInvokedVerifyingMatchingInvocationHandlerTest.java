 ...
 * @author Tim Ducheyne
 */
public class MatchingInvocationHandlerFactoryCreateAssertNotInvokedVerifyingMatchingInvocationHandlerTest extends UnitilsJUnit4 {
    ...
    @Test
    public void createAssertNotInvokedVerifyingMatchingInvocationHandler() {
        MatchingInvocationHandler result = matchingInvocationHandlerFactory.createAssertNotInvokedVerifyingMatchingInvocationHandler();
        assertTrue(result instanceof AssertNotInvokedVerifyingMatchingInvocationHandler);
