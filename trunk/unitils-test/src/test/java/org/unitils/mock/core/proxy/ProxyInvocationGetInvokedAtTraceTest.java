 ...
 * @author Tim Ducheyne
 */
public class ProxyInvocationGetInvokedAtTraceTest {
    ...
    @Test
    public void getInvokedAtTrace() throws Throwable {
        StackTraceElement[] result = proxyInvocation.getInvokedAtTrace();
