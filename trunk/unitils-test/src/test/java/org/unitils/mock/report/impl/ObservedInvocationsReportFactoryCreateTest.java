 ...
 * @author Tim Ducheyne
 */
public class ObservedInvocationsReportFactoryCreateTest extends UnitilsJUnit4 {

    private ObservedInvocationsReportFactory observedInvocationsReportFactory;


    @Test
    public void create() {
        observedInvocationsReportFactory = new ObservedInvocationsReportFactory(1, 2, 3);

        ObservedInvocationsReport result = observedInvocationsReportFactory.create();
    ...
    public void defaultValues() {
        observedInvocationsReportFactory = new ObservedInvocationsReportFactory(null, null, null);
