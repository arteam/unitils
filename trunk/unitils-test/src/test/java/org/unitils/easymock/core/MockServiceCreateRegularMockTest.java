 ...
 * @author Tim Ducheyne
 */
public class MockServiceCreateRegularMockTest extends UnitilsJUnit4 {
    ...
    public void initialize() throws Exception {
        ...
        mocksControlFactoryMock.returns(mocksControlMock).createRegularMocksControl(MyInterface.class, InvocationOrder.DEFAULT, Calls.DEFAULT);
        mocksControlMock.returns(mockObject).createMock(MyInterface.class);
    }


    @Test
    public void createRegularMock() {
        MyInterface result = mockService.createRegularMock(MyInterface.class, InvocationOrder.DEFAULT, Calls.DEFAULT);
