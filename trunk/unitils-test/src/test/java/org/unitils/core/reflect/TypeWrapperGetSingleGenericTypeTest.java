...
public class TypeWrapperGetSingleGenericTypeTest {
    ...
    public void exceptionWhenNoTypeParameters() {
        try {
            ...
            assertEquals("Unable to determine unique generic type for type: org.unitils.core.reflect.TypeWrapperGetSingleGenericTypeTest.org.unitils.core.reflect.TypeWrapperGetSingleGenericTypeTest$MyGenericClass<java.lang.String>.MyGenericInnerClass.\n" +
                    "Type is not a generic type.", e.getMessage());
        }
    }
