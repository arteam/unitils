 ...
 * @author Tim Ducheyne
 */
public class SqlAssertAssertLongIntegrationTest {
    ...
    public void assertionSuccessfulForDefaultDatabase() throws Exception {
        ...
        SqlAssert.assertLong(111, "select value from my_table");
    }
    ...
    public void assertionFailedForDefaultDatabase() throws Exception {
        executeUpdate("insert into my_table (value) values (111)");
        try {
            SqlAssert.assertLong(222, "select value from my_table");
    ...
    public void assertionSuccessfulForNamedDatabase() throws Exception {
        ...
        SqlAssert.assertLong(111, "select value from my_table", "database2");
    }
    ...
    public void assertionFailedForNamedDatabase() throws Exception {
        executeUpdate("insert into my_table (value) values (111)", "database2");
        try {
            SqlAssert.assertLong(222, "select value from my_table", "database2");
            fail("AssertionError expected");
        } catch (AssertionError e) {
            assertEquals("Different result found for query 'select value from my_table': expected:<222> but was:<111>", e.getMessage());
        }
    ...
    public void exceptionWhenNonLongValue() throws Exception {
        ...
        try {
            SqlAssert.assertLong(111, "select other from my_table");
            fail("UnitilsException expected");
        } catch (UnitilsException e) {
            assertEquals("Unable to execute statement: 'select other from my_table'. Reason:\n" +
                    "StatementCallback; bad SQL grammar [select other from my_table]; nested exception is java.sql.SQLException: Wrong data type: type: VARCHAR (12) expected: BIGINT value: xxx", e.getMessage());
        }
    }
    ...
    public void exceptionWhenDatabaseNameNotFound() throws Exception {
        try {
            SqlAssert.assertLong(111, "select value from my_table", "xxx");
            fail("UnitilsException expected");
        } catch (UnitilsException e) {
