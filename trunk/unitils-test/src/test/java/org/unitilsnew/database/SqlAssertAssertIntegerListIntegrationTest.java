 ...
 * @author Tim Ducheyne
 */
public class SqlAssertAssertIntegerListIntegrationTest {
    ...
    public void assertionSuccessfulForDefaultDatabase() throws Exception {
        ...
        SqlAssert.assertIntegerList(asList(111, 222), "select value from my_table");
    }
    ...
    public void orderIsIgnored() throws Exception {
        executeUpdate("insert into my_table (value) values (111)");
        executeUpdate("insert into my_table (value) values (222)");
        SqlAssert.assertIntegerList(asList(222, 111), "select value from my_table");
    }
    ...
    public void assertionSuccessfulForNamedDatabase() throws Exception {
        ...
        SqlAssert.assertIntegerList(asList(111, 222), "select value from my_table", "database2");
    }
    ...
    public void assertionSuccessfulForEmptyResult() throws Exception {
        SqlAssert.assertIntegerList(Collections.<Integer>emptyList(), "select value from my_table");
    }
    ...
    public void assertionSuccessfulForNullValue() throws Exception {
        ...
        executeUpdate("insert into my_table (value) values (null)");
        SqlAssert.assertIntegerList(Arrays.<Integer>asList(null, null), "select value from my_table");
    }
    ...
    public void exceptionWhenNonIntegerValue() throws Exception {
        ...
        try {
            SqlAssert.assertIntegerList(asList(111), "select other from my_table");
    ...
    public void exceptionWhenDatabaseNameNotFound() throws Exception {
        try {
            SqlAssert.assertIntegerList(asList(111), "select value from my_table", "xxx");
            fail("UnitilsException expected");
        } catch (UnitilsException e) {
    ...
    public void exceptionWhenInvalidStatement() throws Exception {
        try {
            SqlAssert.assertIntegerList(asList(111), "xxx");
            fail("UnitilsException expected");
        } catch (UnitilsException e) {
