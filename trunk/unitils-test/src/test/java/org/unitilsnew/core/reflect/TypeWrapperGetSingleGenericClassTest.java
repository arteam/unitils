...
public class TypeWrapperGetSingleGenericClassTest {
    ...
    public void exceptionWhenNoTypeParameters() {
        try {
            ...
            assertEquals("Unable to determine unique generic type for type: org.unitilsnew.core.reflect.TypeWrapperGetSingleGenericClassTest.org.unitilsnew.core.reflect.TypeWrapperGetSingleGenericClassTest$MyGenericClass<java.lang.String>.MyGenericInnerClass.\n" +
                    "Type is not a generic type.", e.getMessage());
        }
    }
