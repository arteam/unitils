 ...
 * @author Tim Ducheyne
 */
public class ClassWrapperGetStaticFieldsOfTypeTest {
    ...
    @Test
    public void getStaticFieldsOfType() {
        classWrapper = new ClassWrapper(MyClass.class);

        List<FieldWrapper> result = classWrapper.getStaticFieldsOfType(Type1.class);
        assertPropertyLenientEquals("wrappedField", asList(field1a, field1b, field4), result);
    }
    ...
    public void emptyWhenNoFieldsFoundOfType() {
        ...
        List<FieldWrapper> result = classWrapper.getStaticFieldsOfType(Map.class);
    ...
    public void exceptionWhenNullType() {
        try {
            classWrapper = new ClassWrapper(MyClass.class);
            classWrapper.getStaticFieldsOfType(null);
            fail("UnitilsException expected");
        } catch (UnitilsException e) {
            assertEquals("Unable to get static fields of type. Type cannot be null.", e.getMessage());
        }
    }
