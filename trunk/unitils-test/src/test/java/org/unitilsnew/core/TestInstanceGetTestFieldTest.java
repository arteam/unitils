...
public class TestInstanceGetTestFieldTest {
    ...
    public void exceptionWhenFieldNotFound() {
        try {
            ...
            assertEquals("Unable to get field with name 'xxxx'. No such field exists on class org.unitilsnew.core.TestInstanceGetTestFieldTest$MyClass or one of its superclasses.", e.getMessage());
        }
    }
