...
public class PartialMockProxyInvocationHandler<T> extends MockProxyInvocationHandler<T> {


    public PartialMockProxyInvocationHandler(BehaviorDefiningInvocations behaviorDefiningInvocations1, Scenario scenario, CloneService cloneService, MatchingProxyInvocationHandler matchingProxyInvocationHandler) {
        super(behaviorDefiningInvocations1, scenario, cloneService, matchingProxyInvocationHandler);
    }
