 ...
 * @author Tim Ducheyne
 */
public class DetailedObservedInvocationsReportFactory implements Factory<DetailedObservedInvocationsReport> {
    ...
    public DetailedObservedInvocationsReportFactory(@Property(value = "mock.objectFormatterMaxDepth", optional = true) Integer objectFormatterMaxDepth,
    ...
    public DetailedObservedInvocationsReport create() {
        ...
        return new DetailedObservedInvocationsReport(objectFormatter, maxInlineParameterLength);
    }
}
