...
/**
 * Test class for {@link be.ordina.unitils.reflectionassert.ReflectionAssert}.
 */
public class ReflectionAssertTest extends TestCase {
    ...
    public void testCheckEquals_leftNull() {
        ...
        StringAssert.assertContains("be.ordina.unitils.reflectionassert.ReflectionAssertTest$Objects", message);
    }
