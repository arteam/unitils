...
public class DataSetXmlReaderTest extends UnitilsJUnit3 {
    ...
    public void testLoadDataSet_lessColumnsLast() throws Exception {
        ...
        multiSchemaXmlDataSetReader.readDataSetXml(result, new ByteArrayInputStream(XML_LESS_COLUMNS_LAST.getBytes()));
        ...
        IDataSet dataSet = result.getDataSetsForSchema("SCHEMA_A").get(0);
    ...
    public void testLoadDataSet_lessColumnsFirst() throws Exception {
    	MultiSchemaDataSet result = new MultiSchemaDataSet();
        multiSchemaXmlDataSetReader.readDataSetXml(result, new ByteArrayInputStream(XML_LESS_COLUMNS_FIRST.getBytes()));
    ...
    public void testLoadDataSet_multiSchema() throws Exception {
    	MultiSchemaDataSet result = new MultiSchemaDataSet();
        multiSchemaXmlDataSetReader.readDataSetXml(result, new ByteArrayInputStream(XML_MULTI_SCHEMA.getBytes()));
    ...
    public void testLoadDataSet_multiSchemaNoDefault() throws Exception {
    	MultiSchemaDataSet result = new MultiSchemaDataSet();
        multiSchemaXmlDataSetReader.readDataSetXml(result, new ByteArrayInputStream(XML_MULTI_SCHEMA_NO_DEFAULT.getBytes()));

        // there should be 3 schemas
        assertLenEquals(new String[]{"SCHEMA_A", "SCHEMA_B", "SCHEMA_C"}, result.getSchemaNames());

        // default schema A should contain 3 tables
        IDataSet dataSetA = result.getDataSetsForSchema("SCHEMA_A").get(0);
        assertLenEquals(new String[]{"TABLE_A", "TABLE_A", "TABLE_A"}, dataSetA.getTableNames());
