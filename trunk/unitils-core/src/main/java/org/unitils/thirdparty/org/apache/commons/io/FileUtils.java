...
public class FileUtils {
     ...
     */
    protected static String[] toSuffixes(String[] extensions) {
     ...
     * @since Commons IO 1.1
     */
    protected static void doCopyDirectory(File srcDir, File destDir, boolean preserveFileDate) throws IOException {
        if (destDir.exists()) {
     ...
     * @throws IOException          in case deletion is unsuccessful
     */
    protected static void deleteDirectoryOnExit(File directory) throws IOException {
        if (!directory.exists()) {
            return;
        }
     ...
     * @throws IOException          in case cleaning is unsuccessful
     */
    protected static void cleanDirectoryOnExit(File directory) throws IOException {
        if (!directory.exists()) {
            String message = directory + " does not exist";
            throw new IllegalArgumentException(message);
        }
