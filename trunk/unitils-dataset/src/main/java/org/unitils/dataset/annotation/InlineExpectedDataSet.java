...
import org.unitils.dataset.annotation.handler.impl.InlineExpectedDataSetAnnotationHandler;
...
@Retention(RUNTIME)
@Inherited
@MarkerForExpectedDataSetAnnotation(InlineExpectedDataSetAnnotationHandler.class)
public @interface InlineExpectedDataSet {
