 ...
 * @author Filip Neven
 */
public class InsertPreparedStatementWrapper extends PreparedStatementWrapper {
    ...
    public InsertPreparedStatementWrapper(String schemaName, String tableName, Connection connection) throws SQLException {
