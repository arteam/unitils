 ...
 */
package org.unitils.dataset.resolver.impl;
 ...
 * path prefix data sets      --> looks for datasets/myDataSet.xml on the classpath
 * <p/>
...
public class DefaultDataSetResolver implements DataSetResolver {
     ...
     */
    public static final String PROPKEY_PREFIX_WITH_PACKAGE_NAME = "dataset.datasetresolver.prefixWithPackageName";

    /**
     * Property key for the path prefix
     */
    public static final String PROPKEY_DATA_SET_PATH_PREFIX = "dataset.datasetresolver.pathPrefix";
