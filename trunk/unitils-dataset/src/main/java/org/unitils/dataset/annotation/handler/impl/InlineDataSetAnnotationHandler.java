...
import org.unitils.dataset.annotation.InlineDataSet;
...
/**
 * Handles the execution of the {@link org.unitils.dataset.annotation.InlineCleanInsertDataSet} annotation.
 *
 * @author Tim Ducheyne
 * @author Filip Neven
 */
public class InlineDataSetAnnotationHandler implements DataSetAnnotationHandler<InlineDataSet> {


    public void handle(InlineDataSet annotation, Method testMethod, Object testInstance, DataSetModule dataSetModule) {
