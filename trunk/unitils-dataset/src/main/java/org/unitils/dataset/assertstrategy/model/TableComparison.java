...
public class TableComparison {
    ...
    /**
     * @return The best results in the assertstrategy between the rows, not null
     */
     ...
     * @return The best assertstrategy for the given rows, not null
     */
     ...
     *
     * @param rowComparison The assertstrategy result, not null
     */
