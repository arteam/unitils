...
import org.unitils.dataset.annotation.handler.impl.UpdateDataSetAnnotationHandler;
 ...
 * <br/><br/>
 * Update means that a record with the same primary key values will be updated. If no such record
 * exists in the database, an exception will be raised. If no or not all values for the PK columns are provided in the data set,
 * an exception will be raised.
 * See {@link CleanInsertDataSet}, {@link InsertDataSet} and {@link RefreshDataSet} for other possible ways of loading.
 * <br/><br/>
 ...
 * '
 * '        @Test
 * '        @UpdateDataSet("aCustomFileName.xml")
 * '        public void method2(){
 * '        }
 * '    }
 * </code></pre>
...
@Retention(RUNTIME)
@Inherited
@MarkerForLoadDataSetAnnotation(UpdateDataSetAnnotationHandler.class)
