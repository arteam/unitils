...
/**
 * Handles the execution of the {@link org.unitils.dataset.annotation.CleanInsertDataSet} annotation.
 *
 * @author Tim Ducheyne
 * @author Filip Neven
 */
public class CleanInsertDataSetAnnotationHandler implements DataSetAnnotationHandler<CleanInsertDataSet> {

    public void handle(CleanInsertDataSet annotation, Method testMethod, Object testInstance, DataSetModule dataSetModule) {
