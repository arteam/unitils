...
import org.unitils.dataset.annotation.handler.impl.DataSetRefreshAnnotationHandler;
 ...
 * See {@link org.unitils.dataset.annotation.DataSetCleanInsert} and {@link org.unitils.dataset.annotation.DataSetInsert}
 ...
 * '
 * '        @Test
 * '        @DataSetRefresh("aCustomFileName.xml")
 * '        public void method2(){
 * '        }
 * '    }
 * </code></pre>
...
@Retention(RUNTIME)
@Inherited
@MarkerForLoadDataSetAnnotation(DataSetRefreshAnnotationHandler.class)
