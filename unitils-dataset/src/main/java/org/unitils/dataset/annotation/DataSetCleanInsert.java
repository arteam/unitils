...
import org.unitils.dataset.annotation.handler.impl.DataSetCleanInsertAnnotationHandler;
 ...
 * is loaded. Tables that are not mentioned in the data set will not be touched. See {@link org.unitils.dataset.annotation.DataSetInsert} and
 ...
 * '
 * '        @Test
 * '        @DataSetCleanInsert("aCustomFileName.xml")
 * '        public void method2(){
 * '        }
 * '    }
 * </code></pre>
...
@Retention(RUNTIME)
@Inherited
@MarkerForLoadDataSetAnnotation(DataSetCleanInsertAnnotationHandler.class)
