...
import org.unitils.dataset.annotation.handler.impl.InsertDataSetAnnotationHandler;
 ...
 * '
 * '        @Test
 * '        @InsertDataSet("aCustomFileName.xml")
 * '        public void method2(){
 * '        }
 * '    }
 * </code></pre>
...
@Retention(RUNTIME)
@Inherited
@MarkerForLoadDataSetAnnotation(InsertDataSetAnnotationHandler.class)
