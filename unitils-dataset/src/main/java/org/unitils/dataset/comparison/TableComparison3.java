...
public class TableComparison3 {
    ...
    private Map<Row, RowComparison2> bestRowComparisons = new LinkedHashMap<Row, RowComparison2>();
     ...
     */
    public TableComparison3(Table dataSetTable) {
    ...
    public boolean hasMatch(Row row) {
        RowComparison2 rowComparison = bestRowComparisons.get(row);
     ...
     */
    public boolean isRowAlreadyMatched(String rowIdentifier) {
     ...
     */
    public List<RowComparison2> getBestRowComparisons() {
        return new ArrayList<RowComparison2>(bestRowComparisons.values());
    }
     ...
     */
    public void replaceIfBetterRowComparison(String rowIdentifier, RowComparison2 rowComparison) {
        Row dataSetRow = rowComparison.getDataSetRow();
        RowComparison2 currentRowComparison = bestRowComparisons.get(dataSetRow);
    ...
    public boolean isMatch() {
        ...
        for (RowComparison2 rowComparison : bestRowComparisons.values()) {
