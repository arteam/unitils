 ...
 * @author Filip Neven
 */
public class ExpectedDataSetAssert {
     ...
     */
    public void assertEqual(DataSet expectedDataSet, List<String> variables, DataSetComparator dataSetComparator) throws AssertionError {
