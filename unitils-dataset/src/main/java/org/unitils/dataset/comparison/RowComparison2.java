 ...
 * @author Filip Neven
 */
public class RowComparison2 {

    /* The data set row that was compared */
    private Row dataSetRow;

    /* The column comparison results */
    private List<ColumnComparison2> columnComparisons = new ArrayList<ColumnComparison2>();
     ...
     */
    public RowComparison2(Row dataSetRow) {
     ...
     */
    public List<ColumnComparison2> getColumnComparisons() {
     ...
     */
    public void addColumnComparison(ColumnComparison2 columnComparison) {
    ...
    public int getNrOfPrimaryKeyDifferences() {
        ...
        for (ColumnComparison2 columnComparison : columnComparisons) {
     ...
     */
    public boolean isBetterMatch(RowComparison2 rowComparison) {
