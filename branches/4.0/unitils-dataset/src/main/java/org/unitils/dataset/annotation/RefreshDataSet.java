...
import org.unitils.dataset.annotation.handler.impl.RefreshDataSetAnnotationHandler;
 ...
 * '
 * '        @Test
 * '        @RefreshDataSet("aCustomFileName.xml")
 * '        public void method2(){
 * '        }
 * '    }
 * </code></pre>
...
@Retention(RUNTIME)
@Inherited
@MarkerForLoadDataSetAnnotation(RefreshDataSetAnnotationHandler.class)
public @interface RefreshDataSet {
