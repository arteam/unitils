...
import org.unitils.dataset.annotation.handler.impl.InlineRefreshDataSetAnnotationHandler;
...
@Retention(RUNTIME)
@Inherited
@MarkerForLoadDataSetAnnotation(InlineRefreshDataSetAnnotationHandler.class)
public @interface InlineRefreshDataSet {
