 ...
 * @author Tim Ducheyne
 */
public class MultiDbDataSetAnnotationTest extends MultiDbDataSetTestBase {
    ...
    public void notAnnotated() throws Exception {
        ...
        assertValueNotInTable("TEST", "col1", "xxxx", dataSource1);
        assertValueNotInTable("TEST", "col1", "xxxx", dataSource2);
    }


    @MultiDataSet({
        @DataSet(value = "DataSetModuleDataSetTest-simple.xml", databaseName = "unitils1"),
        @DataSet(value = "DataSetModuleDataSetTest-simple.xml", databaseName = "unitils2")
    })
