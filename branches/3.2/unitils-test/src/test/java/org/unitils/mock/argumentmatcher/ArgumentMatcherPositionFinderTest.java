...
public class ArgumentMatcherPositionFinderTest {
    ...
    public static class TestClass {
        ...
        public void test() {
            ...
            mockObject.performs(dummyBehavior).someMethod("aValue", "aValue", notNull(String.class));
            // 2 different invocations on same line  DO NOT FORMAT
            mockObject.performs(dummyBehavior).someMethod(notNull(String.class), "aValue", "aValue");
            mockObject.performs(dummyBehavior).valueReturningMethod("aValue", "aValue", notNull(String.class));
