...
public class PostgreSqlDbSupport extends DbSupport {
    ...
    public Set<String> getSequenceNames() {
        ...
        // Should be replaced by the original query on information_schema.sequences in future, since
        // this is a more elegant solution
        // This is the original query:
        // getItemsAsStringSet("select sequence_name from information_schema.sequences where
        // sequence_schema = '" + getSchemaName() + "'", getDataSource());
        return getSQLHandler()
                .getItemsAsStringSet(
    ...
    public void incrementSequenceToValue(String sequenceName, long newSequenceValue) {
        getSQLHandler().getItemAsLong(
                "select setval('" + qualified(sequenceName) + "', " + newSequenceValue + ")");
    }
    ...
    public void removeForeignKeyConstraint(String tableName, String constraintName) {
        getSQLHandler().executeUpdate(
                "alter table " + qualified(tableName) + " drop constraint \"" + constraintName
                        + "\"");
    }
    ...
    public void removeNotNullConstraint(String tableName, String columnName) {
        getSQLHandler().executeUpdate(
                "alter table " + qualified(tableName) + " alter column " + columnName
                        + " drop not null");
    }
