...
public interface ConstraintsDisabler {
     ...
     *
     * @param configuration
     * @param dataSource       The dataSource that defines the connection to the database
     * @param statementHandler Implementation of StatementHandler, to which all constraints disabling and enabling statements are issued, that
     */
