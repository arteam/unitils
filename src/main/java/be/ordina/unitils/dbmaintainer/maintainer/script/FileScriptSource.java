...
public class FileScriptSource implements ScriptSource {
    ...
    /**
     * @see ScriptSource#shouldRunFromScratch(be.ordina.unitils.dbmaintainer.maintainer.version.Version)
     */
    ...
    /**
     * @see ScriptSource#getScripts(be.ordina.unitils.dbmaintainer.maintainer.version.Version)
     */
